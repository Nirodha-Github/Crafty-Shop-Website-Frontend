...
import loginCover from './../../../assets/frontend/images/auth/authCover.jpeg';
            ...
            <div className="card loginCard shadow-lg">
                <div className="row p-0 m-0">
                    <div className="col-sm-4 p-0 m-0">
                        <img className="img-fluid h-100 " width={"100%"} src={loginCover} alt="authCoverImage" />
                    </div>
                    <div className="col-sm-8 row p-0 m-0 col-12">
                        <div className="card-header col-sm-12 h3 text-center" id="authHeader">Crafty Shop - Login</div>
                        <form className="card-body authBody col-sm-12" onSubmit={loginSubmit}>
                            <div className="form-row m-2">
                                ...
                                <span className="row text-danger">{loginInput.error_list.email}</span>
                            </div>
                            <div className="form-row m-2">
                                <div className="form-group row gx-3">
                                ...
                                <span className="row text-danger">{loginInput.error_list.password}</span>
                            </div>
